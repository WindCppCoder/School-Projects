...
project1:  pseudoserver.o tree.o main.o bitcoin.o pseudoservernode.o
	$(CXX) $(CXXFLAGS) -o project1  main.o pseudoserver.o tree.o bitcoin.o pseudoservernode.o

main.o: main.cpp pseudoserver.h tree.h bitcoin.h pseudoservernode.h
	$(CXX) $(CXX_FLAGS)  -c main.cpp

pseudoserver.o: pseudoserver.cpp pseudoserver.h 
	$(CXX) $(CXX_FLAGS)  -c pseudoserver.cpp

pseudoservernode.o: pseudoservernode.cpp pseudoservernode.h
	$(CXX) $(CXX_FLAGS) -c pseudoservernode.cpp
